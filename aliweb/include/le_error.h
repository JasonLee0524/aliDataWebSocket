...
/**
 * @def     general errors
 * @brief   for all linkedge modules
 * @user    all linkedge modules
 */
#define    LE_SUCCESS                               0              /* 请求成功*/
#define    LE_FAIL                               -1              /* 请求失败*/
...
/**
 * @def     LEDA errors
 * @brief   only for linkedge driver module
 * @user    device access
 */
...
#define    LEDA_ERROR_CFG_FILE_ARGS                 109009         /* 配置文件参数错误*/
#define    LEDA_ERROR_PATH_FAULT                    109010         /* 路径错误*/
#define    LEDA_ERROR_EXCEPTION_CODE                109012         /* 异常码*/
#define    LEDA_ERROR_NAME_EXISTED                  109013         /* 名字已存在*/
#define    LEDA_ERROR_CONNECTION                    109014         /* 连接错误*/
#define    LEDA_ERROR_TRANSLATION                   109015         /* 转换错误*/
#define    LEDA_ERROR_DECODE                        109016         /* 解码错误*/
#define    LEDA_ERROR_ENCODE                        109017         /* 编码错误*/
